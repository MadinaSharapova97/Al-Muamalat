...
export default function Consultation() {
    return (
        <div className='py-20 px-4 md:px-0 '>
            <div className='flex flex-col md:flex-row max-w-6xl h-screen md:h-[370px] mx-auto items-center justify-center'>
                {/* left */}
                ...
                <div className='p-12 bg-[#F9F7F3] w-full md:w-2/3 h-full'>
                    ...
                    <p className='text-[#152032]'>Leave your phone number, and we will reach out to provide you with complete information about our courses. </p>
